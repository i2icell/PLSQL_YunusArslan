...
--GET BALANCES TEST;
DECLARE
PIS_PHONE   USER_PKG_BALANCE.PHONE_NUMBER%TYPE    := '5317719022';
...
DECLARE
PIS_PHONE       USER_PKG_BALANCE.PHONE_NUMBER%TYPE    := '5077189999';
...
--SHOW PROFILE TEST;
DECLARE
PIS_PHONE   USER_INFO.PHONE_NUMBER%TYPE :='5377399999';
...
BEGIN
    SHOW_PROFILE(PIS_PHONE,FNAME,LNAME,E_MAIL,PACK_NAME);
END;
/