...
PIS_NEW_PASS    USER_INFO.PASS_WORD%TYPE        := 'Yunus123456';
CHECKER NUMBER;
BEGIN
...
PIS_L_NAME       USER_INFO.LAST_NAME%TYPE       :='DENEME3'; 
PIS_P_NUMBER     USER_INFO.PHONE_NUMBER%TYPE    :='5554446151';
PIS_E_MAIL       USER_INFO.EMAIL%TYPE           :='mail@mail2.com'; 
PIS_P_WORD       USER_INFO.PASS_WORD%TYPE       :='Mammamia07';
PIS_B_DAY        USER_INFO.BIRTHDATE%TYPE       :='05-01-1990';
PIS_TC_NUMBER    USER_INFO.TC_NO%TYPE           :='54544544999';
CHECKER         NUMBER;
BEGIN
