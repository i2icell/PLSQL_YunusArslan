...
--CREATE USER TEST;
DECLARE
PIS_F_NAME       USER_INFO.FIRST_NAME%TYPE      :='harley';
PIS_L_NAME       USER_INFO.LAST_NAME%TYPE       :='quinn'; 
PIS_P_NUMBER     USER_INFO.PHONE_NUMBER%TYPE    :='5445455456';
PIS_E_MAIL       USER_INFO.EMAIL%TYPE           :='queen@joker.com'; 
PIS_P_WORD       USER_INFO.PASS_WORD%TYPE       :='DamnBatman<3';
PIS_B_DAY        USER_INFO.BIRTHDATE%TYPE       :='05-01-1995';
PIS_TC_NUMBER    USER_INFO.TC_NO%TYPE           :='35458319176';
CHECKER         NUMBER;
BEGIN
