...
BEGIN
    ...
    INSERT INTO USER_INFO VALUES (SEQ_USER_ID.NEXTVAL,UPPER(PIS_F_NAME),UPPER(PIS_L_NAME),PIS_P_NUMBER,PIS_E_MAIL,MD5_HASH(PIS_P_WORD),TO_DATE(PIS_B_DAY,'DD/MM/YYYY'),PIS_TC_NUMBER);
    COMMIT;
